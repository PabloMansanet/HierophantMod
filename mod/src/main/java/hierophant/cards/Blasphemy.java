...
public class Blasphemy extends AbstractDynamicCard {
    public static final String POWER_ID = HierophantMod.makeID("PietyPower");
    public static final String ID = HierophantMod.makeID(Blasphemy.class.getSimpleName());
