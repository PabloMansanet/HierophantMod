...
public class GlossolaliaPower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("glossolalia_big.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("glossolalia_small.png"));
